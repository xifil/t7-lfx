...
namespace demonware {
	...
	bool byte_buffer::read_array_header(const unsigned char expected, unsigned int* element_count, unsigned int* element_size) {
		if (element_count) {
			*element_count = 0;
		}
	...
	bool byte_buffer::write_array_header(const unsigned char type, const unsigned int element_count, const unsigned int element_size) {
