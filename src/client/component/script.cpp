...
namespace script {
	namespace {
		...
		void scr_loot_get_item_quantity_stub([[maybe_unused]] game::scriptInstance_t inst, [[maybe_unused]] game::scr_entref_t entref) {
	...
	struct component final : generic_component {
		void post_unpack() override {
			...
			gscr_get_bgb_remaining_hook.create(game::select(0x141A8CAB0, 0x1402D2310), scr_loot_get_item_quantity_stub);
		}
	};
};
